...
and cancer data analysis.
- Applied supervised learning techniques (classi ication and regression) on tumor transcriptomic dataset
and predicted tumor response to different medications
- Used Python libraries such as Pandas, NumPy, Matplotlib, and Scikit-Learn for EDA and developed
prediction models. Used model evaluation techniques such Train/Test Split, K-cross validation, and
bootstrap sampling.
...
- Used AI tools such as ElevenLabs to create and clone voiceover for marketing animated videos.
...
- Leaded and managed summer virtual sessions to train and prepare a team 40 orientation leader for the fall orientation.

## Leadership Highlights
- Supported incoming international students through orientation
- Hosted virtual sessions and helped students navigate resources
- Participated in hackathons, workshops, and research exploration
